...
class CalorieController extends Controller
{
    public function calculate(Request $request)
    {
        ...
        return response()->json([
            ...
            'fat' => $fat,
            'carbs' => $carbs,
            'minimalDeficit' => $minimalDeficit,
            'balancedDeficit' => $balancedDeficit,
            'extremeDeficit' => $extremeDeficit,
            'minimalSurplus' => $minimalSurplus,
            'balancedSurplus' => $balancedSurplus,
            'extremeSurplus' => $extremeSurplus,
            'data' => $data,
        ]);
    }
    ...
    public function history(Request $request)
    {
        ...
        // dd($user);
        if ($user->histories) {
            return response()->json($user->histories);
        } else {
