    ...
    <section class="min-h-screen py-16 sm:py-24 bg-gradient-to-br from-blue-600 via-indigo-500 to-violet-500">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 text-center space-x-4">
                <a href="{{ route('home') }}"
                    class="inline-flex items-center px-6 py-3 text-lg font-semibold text-white bg-blue-600 rounded-full shadow-md hover:bg-blue-700 transition duration-300 transform hover:scale-105">
                    <span class="mr-2">🔄</span> Calculate Again
                </a>
                <a href="{{ route('dietplan', ['data' => 'data']) }}"
                    class="inline-flex items-center px-6 py-3 text-lg font-semibold text-white bg-blue-600 rounded-full shadow-md hover:bg-blue-700 transition duration-300 transform hover:scale-105">
                    <span class="mr-2">📋</span> Get Diet Plan
                </a>
            </div>
        </div>
    </section>
